  ...
  return (
    <>
      <div className={`skeletonHolder`}>
        <div class="flex self-start  flex-col items-center bg-gray-50 border border-gray-200 rounded-lg shadow md:flex-row hover:bg-gray-100 dark:border-gray-700 dark:bg-[#252525] dark:hover:bg-gray-800 productSkeleton">
          <Link href="/">
            <img
          ...
          <div class="flex flex-col  justify-between justify-self-end p-4 leading-normal">
            <Section>
