        ...
        <div className="bg-white dark:bg-[#131313] rounded-lg w-full">
          <div className="py-14 px-4 md:px-6 2xl:px-20 2xl:container 2xl:mx-auto">
            <div className="flex justify-start item-start space-y-2 flex-col">
              <h1 className="text-3xl dark:text-gray-300 lg:text-4xl font-semibold leading-7 lg:leading-9 text-gray-700">
                Order Id: #{order._id}
              </h1>
            ...
            <div className="mt-10 flex flex-col xl:flex-row jusitfy-center items-stretch w-full xl:space-x-8 space-y-4 md:space-y-6 xl:space-y-0">
              <div className="flex flex-col justify-start items-start w-full space-y-4 md:space-y-6 xl:space-y-8">
                <div className="flex flex-col justify-start items-start dark:bg-[#171717]  rounded-lg shadow-xl bg-gray-50 px-4 py-4 md:py-6 md:p-6 xl:p-8 w-full">
                  <p className="text-lg md:text-xl dark:text-gray-300 font-semibold leading-6 xl:leading-5 text-gray-800">
                    Customer's Cart
                  </p>
                      ...
                      <div key={product.product._id} className="mt-4 md:mt-6 flex flex-col md:flex-row justify-start items-start md:items-center md:space-x-6 xl:space-x-8 w-full">
                        ...
                        <div className="border-b border-teal-500 dark:border-teal-700 md:flex-row flex-col flex justify-between items-start w-full pb-8 space-y-4 md:space-y-0">
                          <div className="w-full flex flex-col justify-start items-start space-y-8">
                            <h3 className="text-xl dark:text-gray-300 xl:text-2xl font-semibold leading-6 text-gray-800">
                          ...
                          <div className="flex justify-between space-x-8 items-start w-full">
                            ...
                            <p className="text-base dark:text-gray-300 xl:text-lg leading-6 text-gray-800">
                              {product.quantity}
                            </p>
                  ...
                  <div className="flex flex-col px-4 py-6 md:p-6 xl:p-8 w-full bg-gray-50 dark:bg-[#171717] space-y-6 rounded-lg shadow-xl">
                    ...
                    <div className="flex justify-center items-center w-full space-y-4 flex-col border-teal-500 dark:border-teal-700 border-b pb-4">
                      <div className="flex justify-between w-full">
                        <p className="text-base dark:text-gray-300 leading-4 text-gray-800">
                          Sub-Total
                        </p>
                    ...
                    <div className="flex justify-between items-center w-full">
                      <p className="text-base dark:text-gray-300 font-semibold leading-4 text-gray-800">
                        Total
                      </p>
                  ...
                  <div className="flex justify-between xl:h-full items-stretch w-full flex-col mt-6 md:mt-0">
                    <div className="flex justify-center md:justify-start xl:flex-col flex-col md:space-x-6 lg:space-x-8 xl:space-x-0 space-y-4 xl:space-y-12 md:space-y-0 md:flex-row items-center md:items-start">
                      <div className="flex justify-center md:justify-start items-center md:items-start flex-col space-y-4 xl:mt-8">
                        <p className="text-base dark:text-gray-300 font-semibold leading-4 text-center md:text-left text-gray-800">
                          Shipping Address
                        </p>
                        <p className="w-48 lg:w-full dark:text-gray-400 xl:w-48 text-center md:text-left text-sm leading-5 text-gray-600">
