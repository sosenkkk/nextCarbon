...
<div className="flex flex-col sm:flex-row">
          <button className="cartBtn text-white" id="orderBtn" onClick={openModal}>
            Order!
          </button>
      ...
      <Modal isOpen={isModalOpen} onClose={closeModal} maxWidth="500px">
        ...
        <h2 className="text-lg text-center sm:text-xl font-bold mb-4">Click "Yes" to proceed with your order!</h2>
        <div className="flex flex-col sm:flex-row">
        <button id="orderBtn" className="cartBtn" onClick={goToPlaceOrder}>Yes</button>
        <button id = "clearBtn" className="cartBtn" onClick={closeModal}>No</button>
          ...
          <button className="cartBtn text-white" id="clearBtn" onClick={deleteFromCartHandler}>
            Clear Cart!
          </button>
        </div>
        </>
        ...
        }
        {
          ...
          <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
            <caption className="p-5 text-lg font-semibold text-left text-gray-800 bg-white dark:text-gray-200 dark:bg-[#171717]">
              Your Cart is Empty
              <p className="mt-1 text-sm font-normal text-gray-500 dark:text-gray-400">
                Add <Link href="/products" className="underline cursor-pointer text-teal-700 dark:text-teal-500">Products</Link> in your cart.
              </p>
            </caption>
            </table>
