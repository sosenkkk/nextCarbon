                  ...
                  <div className=" md:flex bg-[#f7f7f7] dark:bg-[#171717] shawdow-md rounded-lg mb-12">
                    ...
                    <div className="p-8">
                      ...
                      <p className="introduction text-gray-700 dark:text-gray-300 font-normal md:text-lg">
                        ...
                        spaces. We understand the significance of bathrooms in
                        your daily life, and we're committed to enhancing your
                        experience.
                        <br />
                        Our brand is built on three pillars: Innovation,
                        Elegance, and Quality.
                        <br />
                        At Carbon, we believe that your bathroom should be a
                        haven of luxury and functionality.
                      </p>
                    </div>
                  </div>
                </Section>
                  ...
                  <div className=" md:flex bg-[#f7f7f7] dark:bg-[#171717] shawdow-md rounded-lg ">
                    <div className="p-8 ">
                      ...
                      <p className="text-gray-700 dark:text-gray-300 md:text-lg">
                        Carbon was born out of a passion for transforming
                        everyday spaces into extraordinary experiences. <br />
